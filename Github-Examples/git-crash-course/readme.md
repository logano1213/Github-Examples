...
If we wanted to create a git repo in a new project we'd create the folder and the initialize that repo using `git init`
...
> You'll need to generate a Personal Access Token
 ...
 You wll use the PAT as your passsword when you login
 ...
 ```
 For WSL users and if you createa non default key you might need to add it
